...
function ShortnerForm() {
    ...
    const onSubmit = async (values) => {
        ...
        try{
            if(token){
                const result = await axios.post(`https://url-shortener-backend123.herokuapp.com/api/private/shorten`,{longURL : longurl},
                {
                    headers: {
                        ...
                        <Form>
                            <div className="form-row align-items-center">
                                ...
                                <div className="col-auto my-1">
                                    <button type="submit" className="btn btn-primary align-button">Submit</button>
                                </div>
                            </div>
                        </Form>
                    )
